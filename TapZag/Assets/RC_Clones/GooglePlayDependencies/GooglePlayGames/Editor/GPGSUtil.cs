...
namespace GooglePlayGames.Editor
{
    ...
    public static class GPGSUtil
    {
        ...
        /// </summary>
        private const string GameInfoPath = "Assets/RC_Clones/GooglePlayGames/GameInfo.cs";

        public static string modifiedDir = "Assets/RC_Clones/GooglePlayDependencies";
        ...
        {
            return ReadFile(SlashesToPlatformSeparator(GPGSUtil.modifiedDir+"/GooglePlayGames/Editor/" + name + ".txt"));
        }
        ...
        public static bool AndroidManifestExists()
        {
            string destFilename = GPGSUtil.SlashesToPlatformSeparator(
                                      GPGSUtil.modifiedDir+"/Plugins/Android/MainLibProj/AndroidManifest.xml");
